...
#define ELEV_L_PWM_Pin GPIO_PIN_1
#define ELEV_L_PWM_GPIO_Port GPIOA
...
#define ELEV_L_EN_Pin GPIO_PIN_4
#define ELEV_L_EN_GPIO_Port GPIOA
...
#define ELEV_R_EN_Pin GPIO_PIN_1
#define ELEV_R_EN_GPIO_Port GPIOB
#define ELEV_R_PWM_Pin GPIO_PIN_10
#define ELEV_R_PWM_GPIO_Port GPIOB
