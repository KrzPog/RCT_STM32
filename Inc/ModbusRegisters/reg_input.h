...
#define REG_INPUT_COUNT 16

////////////////////////////////////////////////////////////////////////////////

#define REG_INPUT_STATUS_WORD 0x3000
...
#define REG_INPUT_ACCEL_X 0x3014
#define REG_INPUT_ACCEL_Y 0x3016
#define REG_INPUT_ACCEL_Z 0x3018

//! uint16_t, ±250°/s (LSB/°/s: 131)
//! raw = regInput[regInpIx(REG_INPUT_GYRO_X)];
//! gyro_dps = raw / 131.0f;      -> w stopniach na sekundę
#define REG_INPUT_GYRO_X 0x301A
#define REG_INPUT_GYRO_Y 0x301C
#define REG_INPUT_GYRO_Z 0x301E
